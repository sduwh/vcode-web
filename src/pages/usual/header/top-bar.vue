<template>
  <div id="top-bar">
    <el-row>
      ...
      <el-col :sm="24" :md="15" class="nav-wrap">
        <div class="nav">
      ...
      <el-col :md="4" class="logInfo hidden-sm-and-down">
        <template>
          <div style="display:flex;">
            <div v-if="this.$store.state.user.isLogin === false" class="log">
            ...
            <div v-else class="log">
              <span @click="userCenter">{{ this.$store.state.user.nickname }}</span>
