<template>
  <div id="show-problem">
    <div class="main">
      <div class="v-tab">
        <span @click="changeTab" class="description" ref="description"><i class="el-icon-reading"></i> Description</span>
        <span @click="changeTab" class="submission" ref="submission"><i class="el-icon-timer"></i> Submission</span>
        <span @click="changeTab" class="discuss" ref="discuss"><i class="el-icon-chat-line-round"></i> Discuss</span>
      </div>
      <div class="v-panel">
